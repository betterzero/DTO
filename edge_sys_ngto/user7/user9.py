...
device_user_node = "usernode9"
# One usernode device has several edge server sub_topics and the quantity equal to the number of edge servers
user_node_clients = [
{"broker":"192.168.0.103","port":1883,"name":"blank","sub_topic":"usernode7","pub_topic":device_user_node}
]
...
try:
    while Run_Flag:
        ...
        if client.connected_flag:
            #print("user device "+ str(9) + " is publishing~~~~~~~~~~")
