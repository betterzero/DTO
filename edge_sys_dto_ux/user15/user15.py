...
device_user_node_topic = "usernode15/request/area1"
...
class StrategicDecision:
    ...
    def user_node_measure(self):
        ...
        constraints = [probability_server4 >= 0, probability_server4 <= 1, probability_server6 >=0, probability_server6 <=1]

        probability_total = 0
        probability_total = probability_server4 + probability_server6
...
try:
    while Run_Flag:
        ...
        if client.connected_flag:
            #print("user device "+ str(15) + " is publishing~~~~~~~~~~")
