...
device_user_node = "usernode1"
# One usernode device has several edge server sub_topics and the quantity equal to the number of edge servers
user_node_clients = [
{"broker":"192.168.0.103","port":1883,"name":"blank","sub_topic":"usernode17","pub_topic":device_user_node}
]
...
# related user
related_user_workload = {"usernode1": 300, "usernode3": 2400, "usernode5": 2400, "usernode7": 500, "usernode9": 2400, "usernode11": 2400}
...
usable_server_info = {"edgeserver2": 11600}
per_task_resource_requirement = 100
device_user_node_workload = 300
request_resource_capacity = {}

# probability to each server, the data structure is {UE:{server1: pro1, server2: pro2}, UE2:{server1: pro1, server2: pro2}}
