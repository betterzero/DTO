...
device_user_node_topic = "usernode7/request/area1"
...
class StrategicDecision:
    ...
    def user_node_measure(self):
        ...
        constraints = [probability_server2 >= 0, probability_server2 <= 1, probability_server6 >=0, probability_server6 <=1]

        probability_total = 0
        probability_total = probability_server2 + probability_server6

        constraints.append(probability_total == 1)

        temp1_total = 0
        temp2_total = 0
        generate_workload = GenerateWorkload(500)
