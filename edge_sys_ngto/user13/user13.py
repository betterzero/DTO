...
device_user_node = "usernode13"
# One usernode device has several edge server sub_topics and the quantity equal to the number of edge servers
user_node_clients = [
{"broker":"192.168.0.103","port":1883,"name":"blank","sub_topic":"usernode11","pub_topic":device_user_node}
]
...
# related user
related_user_workload = {"usernode3": 2400, "usernode5": 2400, "usernode9": 2400, "usernode11": 2400, "usernode13": 300, "usernode15": 2400}
...
usable_server_info = {"edgeserver4": 6600}
per_task_resource_requirement = 100
device_user_node_workload = 300
...
try:
    while Run_Flag:
        ...
        if client.connected_flag:
            #print("user device "+ str(13) + " is publishing~~~~~~~~~~")
