...
device_user_node = "usernode17"
# One usernode device has several edge server sub_topics and the quantity equal to the number of edge servers
user_node_clients = [
{"broker":"192.168.0.103","port":1883,"name":"blank","sub_topic":"usernode15","pub_topic":device_user_node}
]
...
# related user
related_user_workload = {"usernode7": 500, "usernode9": 2400, "usernode11": 2400, "usernode15": 2400, "usernode17": 300}

# related_edge_user_pair
related_edge_user_pair = {"edgeserver6": ["usernode7", "usernode9", "usernode11","usernode15", "usernode17"]}

# resource requirement and cost(designed to be scalable)
usable_server_info = {"edgeserver6": 15100}
