...
device_edge_server_topic = "edgeserver4/available/area1"
...
{"broker":"192.168.1.111","port":1883,"name":"blank","sub_topic":"usernode13/request/area1","pub_topic":device_edge_server_topic},
...
pub_flag = False
computation_resource_capacity = 6600         # the total computation capacity of this server
...
try:
    while Run_Flag:
        ...
        if client.connected_flag and pub_flag:
            #print("edge server "+ str(4) + " is publishing~~~~~~~~~~" + pub_topic)
